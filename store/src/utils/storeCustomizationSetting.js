const storeCustomization = {
  setting: {
    ...
    slider: {
      ...
      first_title: {
        en: "The Best Quality Products Guaranteed!jghj",
        de: "Die besten Qualitätsprodukte garantiert!nvnv",
      },
      first_description: {
        en: "The Best Quality Products Guaranteed!jhgjgh",
        de: "Die besten Qualitätsprodukte garantiert!nvbnvb",
      },
      first_button: {
        en: "Shop Now",
        de: "Jetzt einkaufen",
      ...
      second_title: {
        en: "Best Different Type of Grocery Storesssssssssssssssssssssssssssssssss",
        de: "Bestes anderes Lebensmittelgeschäft",
      },
      second_description: {
        en: "Quickly aggregate empowered networks after emerging products...ssssssssssssssssssssssssssssss",
      ...
      five_img:
        "https://res.cloudinary.com/ahossain/image/upload/v1697688491/settings/slider-2_o6aezc.jpg",
      five_title: {
        en: "Best Different Type of Grocery Storekgjhkjhkhjkhjgkhjk",
        de: "Bestes anderes Lebensmittelgeschäft",
      },
      five_description: {
        en: "Quickly aggregate empowered networks after emerging products...hfgjhgjkgkjkjhkjhkj",
        de: "Schnelle Bündelung leistungsstarker Netzwerke nach neuen Produkten ...",
      },
      five_button: {
        en: "Shop Now",
